...
// Mensaje formal de agradecimiento
const messageLines = [
    "ESTIMADA GABI,",
    "QUERÍA APROVECHAR ESTE DÍA PARA AGRADECERLE SU GUÍA Y CONFIANZA.",
    "GRACIAS POR SU VALIOSA AMISTAD Y POR INSPIRARME A CRECER CADA DÍA.",
    "QUE ESTE DETALLE LE SAQUE UNA SONRISA.",
